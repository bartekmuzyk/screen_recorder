...
namespace screen_recorder.Recording.Audio.WinCaptureAudio
{
    internal class AudioCaptureHelper : IDisposable
    {
        ...
        private void CaptureSafe()
        {
            ...
            {
                Stop();
                MessageBox.Show(ex.ToString(), "BetterLiveScreen : Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
